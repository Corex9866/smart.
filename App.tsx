...
import AdherenceChart from './AdherenceChart.tsx';
import { getHealthInsights } from './geminiService.ts';
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            ...
            <p className="text-lg font-bold text-slate-700 mt-2">
              {getGreeting()}, <span className="text-blue-600">{userProfile.name}</span>
            </p>
